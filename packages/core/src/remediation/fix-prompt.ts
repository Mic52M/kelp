...
function intro(tool: AiTool): string {
  return tool === "generic"
    ...
    : `Paste this into ${TOOL_LABEL[tool]}:`;
}

/** Fix prompt for an exposed secret. */
export function fixPromptForSecret(finding: SecretFinding, tool: AiTool = "generic"): string {
...
export function fixPromptForRls(finding: RlsFinding, tool: AiTool = "generic"): string {

  ...
  return (
    <form action={action} className="space-y-3">
      ...
      <button
        type="submit"
        disabled={pending}
        className="rounded-lg bg-gradient-to-r from-aqua-400 to-aqua-600 px-4 py-2.5 text-sm font-semibold text-ink-950 transition-opacity hover:opacity-90 disabled:opacity-50"
      >
